...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen md:min-h-[80vh] sm:min-h-auto flex items-center py-2 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-12 lg:py-12 relative w-full">
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 md:gap-4 justify-center lg:justify-start px-4 sm:px-0">
              <button className="btn-primary px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 text-xs sm:text-sm md:text-sm group w-full sm:w-auto">
                Book an Executive Briefing
                <ArrowRight className="inline-block ml-1 sm:ml-2 h-3 w-3 sm:h-4 sm:w-4 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="btn-outline px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 text-xs sm:text-sm md:text-sm w-full sm:w-auto">
