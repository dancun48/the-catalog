...
import doctorImage from '../../assets/images/doc1.jpeg';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="text-4xl font-bold text-primary tracking-tight mb-2 block">
            Physician-Led. Performance-Driven.
          </span>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-display font-semibold mb-6 text-secondary">
              Dr. Erick George Otieno
            </h2>
            <p className="text-lg text-gray-700 mb-6">
              Founded <span className='text-primary font-bold'>The Catalog Healthcare</span> to bridge the gap between preventive healthcare, emotional intelligence, mental health and workplace performance.
            </p>
            ...
            <p className="mt-6 text-primary font-medium">
              Host — <span className='text-secondary font-bold'>The Catalog Podcast™</span> | Advancing Preventive Health & Human Performance Conversations in Africa
            </p>
          </motion.div>
        </div>
      </div>
